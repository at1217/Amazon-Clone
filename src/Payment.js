...
function Payment() {
    ...
    const sendEmail = () => {
        const templateParams = {
            from_name: "amon12171993@gmail.com",
            to_name: user?.email,
    ...
    const handleSubmit = async(event) => {
        ...
        const payload = await stripe.confirmCardPayment(clientSecret, {
            ...
            //paymentIntent = payment confirmation provided by Stripe
            ...
            sendEmail();
            history.replace('/orderconfirmation');
        })
    }
                    ...
                    <div className='payment__details'>
                            <form onSubmit={handleSubmit}>
                                ...
                                <div className='payment__priceContainer'>
                                    <CurrencyFormat 
                                        renderText={(value) => (
                                           <h3 style={{marginTop:5}}>Order Total: {value}</h3>
                                        )}
                                        decimalScale={2}
